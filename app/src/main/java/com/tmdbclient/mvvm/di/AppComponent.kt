...
import com.tmdbclient.mvvm.di.tcblog.TCBlogModule
...
@Singleton
@Component(
    modules = [AndroidSupportInjectionModule::class, ActivityBuilderModule::class, AppModule::class, MoviesViewModelModule::class, MoviesModule::class, TCBlogModule::class]
)
